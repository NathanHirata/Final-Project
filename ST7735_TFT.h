...
#define TFT_DC      	PORTDbits.RD3       // Location of TFT D/C PORTD.3
#define TFT_CS     	 	PORTDbits.RD4       // Location of TFT Chip Select PORTD.4
#define TFT_RST     	PORTDbits.RD2       // Location of TFT Reset PORTD.2
